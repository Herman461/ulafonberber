...
<!--      "-->
      <Transition>
<!--        <perfect-scrollbar @ps-scroll-y="" >-->
        <div @scroll="onContentScroll" :style="{top: `500px`, overflow: 'scroll', height: aboutTextPosition + 'px'}" :class="{hidden: fade}" ref="aboutText" id="about-text" class="about__content">
...
export default {
  ...
  methods: {
    onContentScroll(event) {
      this.contentY = event.target.scrollTop
    },
    onScroll() {
      console.log('scroll')
  ...
  watch: {
    '$route'(from, to) {
      ...
      console.log(this.aboutTextPosition)
