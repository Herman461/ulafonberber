<template>
  <div ref="about" @scroll="onScroll" :class="{'active': isActiveBlock, 'lock': lockScroll, 'home': isHomePage}" class="about">
    <div class="about__body">
      ...
      <Transition>
        <div :class="{hidden: fade}" class="about__content">
          <p>Современной визуальной культуре присуще упрощение образов, в&nbsp;том числе и&nbsp;в&nbsp;скульптуре.
            Абстрактные формы задают нам вопрос: &laquo;Ты&nbsp;чувствуешь?&raquo;. Работы ULAFONBERBER не&nbsp;стремятся к
          ...
          <p class="about__details">
            ...
            древним племенам Северной Африки&nbsp;&mdash; берберам&nbsp;&mdash; сохранить свои традиции и&nbsp;язык, свою истинную
